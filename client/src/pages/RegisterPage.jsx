      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-3 bg-white dark:bg-surface-800 text-surface-500">או</span></div>
          </div>

          <a href={auth.googleUrl()} className="btn-secondary w-full flex items-center justify-center gap-3">
